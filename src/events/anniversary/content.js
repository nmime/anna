...
export const anniversaryEvent = {
  ...
  song: {
    ...
    title: 'Ты случилась',
    text: 'Эта песня попалась мне случайно — но в ней я услышал самое главное: радость, что мы встретились и что ты — со мной. Включи и дочитай эту страницу под нее.',
